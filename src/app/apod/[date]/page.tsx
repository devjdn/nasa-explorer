...
import APODControls from "@/components/ui/apod/controls";
...
export default async function APODDatePage({
    ...
    return (
        <div className="px-4 md:px-8 space-y-8 max-w-prose mx-auto">
            ...
            <Alert className="md:hidden w-fit mx-auto">
                ...
                <AlertDescription className="max-w-[65ch]">
                    NASA's images are often high-resolution and optimized for
                    landscape displays, so for the best viewing experience, we
                    recommend using a desktop device.
                </AlertDescription>
            </Alert>
